		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo application on git",
									"targetURL": "#nsdemogitappdemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsdemogitappdemoapp-display": {
								"semanticObject": "nsdemogitappdemoapp",
								"action": "display",
								"description": "An SAP Fiori application with git",
								"title": "Demo application on git",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsdemogitapp.demoapp",
									"url": sap.ui.require.toUrl("nsdemogitapp/demoapp")
								}
							}
						}
					}
